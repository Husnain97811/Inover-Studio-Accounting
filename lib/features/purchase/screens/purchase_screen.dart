// lib/features/purchase/screens/purchase_screen.dart
      ...
      body: Column(
        ...
        children: [
          const PageHeader(
            ...
            subtitle: "Vendors, GRN, and accounts payable",
          ),
          Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _ComingSoonBanner(
                    title: "Purchase Orders",
                    description:
                        "Create POs, receive goods (GRN), track vendor balances, "
                        "and manage accounts payable — all offline-first.",
                  ),
                      ...
                      return GridView.count(
                        ...
                        children: const [
                          _FeatureCard(
                            ...
                            desc:
                                "Add vendors, track NTN, manage credit terms and balances.",
                            status: "Phase 2",
                          ),
                          _FeatureCard(
                            ...
                            title: "Purchase Orders",
                            desc:
                                "Create POs, confirm with vendor, track expected delivery.",
                            status: "Phase 2",
                          ),
                          _FeatureCard(
                            ...
                            desc:
                                "Receive goods partially or fully. Auto-updates inventory stock.",
                            status: "Phase 2",
                          ),
                        ],
                      );
